#!/usr/bin/env python3
"""
COMPREHENSIVE SWEEP: Check EVERY card for answer-explanation mismatches
"""

import json

def comprehensive_sweep():
    """Check every single card for mismatches"""
    
    # Load the critical fix file
    with open('azure-900-critical-fix.json', 'r') as f:
        flashcards = json.load(f)
    
    print(f"🔍 COMPREHENSIVE SWEEP: Checking ALL {len(flashcards)} cards...\n")
...
if __name__ == "__main__":
    mismatches = comprehensive_sweep()
